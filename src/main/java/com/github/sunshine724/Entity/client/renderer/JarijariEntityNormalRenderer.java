...
public class JarijariEntityNormalRenderer extends MobRenderer<JarijariEntity, JarijariEntityNormalModel<JarijariEntity>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(JarijariMod.MODID,"textures/entity/image2.png");


    public JarijariEntityNormalRenderer(EntityRendererProvider.Context ctx) {
